            ...
            <Container>
                ...
                <div className="rounded-2xl border-2 divide-y-2">
                    ...
                    <div className="flex items-center justify-between p-6">
                        ...
                        <div className="grow"> 
                            <Button onClick={ handleDelete } theme="danger" outline>Locatie overdragen</Button>
                        </div>
                    </div>
                    <div className="flex items-center justify-between p-6">
                        <div className="mr-4">
                        ...
                        <div className="grow"> 
                            <Button onClick={ handleDelete } theme="danger" outline>Zichtbaarheid aanpassen</Button>
                        </div>
                    </div>
                </div>
            </Container>
